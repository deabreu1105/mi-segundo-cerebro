...
- RAG (Retrieval Augmented Generation) - Comparación y contraste
- LLM Wiki Pattern - El patrón principal
- Memex (Vannevar Bush) - Inspiración histórica
- Knowledge Compounding - Valor acumulativo
- Persistent Synthesis - vs re-derivación en cada query
