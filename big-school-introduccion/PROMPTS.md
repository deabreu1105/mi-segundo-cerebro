...
Procesa raw/journal/2026-07-22.md
...
pandoc mi-paper.pdf -o raw/papers/2026-07-22-titulo.md

# Convertir PDF a Markdown (opción B — pdftotext, más simple)
pdftotext mi-paper.pdf - > raw/papers/2026-07-22-titulo.md
```

Luego:
```
Procesa raw/papers/2026-07-22-titulo.md
```
