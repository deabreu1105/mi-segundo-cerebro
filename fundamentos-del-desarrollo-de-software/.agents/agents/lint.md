...
### ☑ 6. `index.md` Desactualizado o Enlaces Ambiguos

Verifica que:
- Cada página en `wiki/sources/` tiene entrada en el índice usando enlaces cualificados (`[[wiki/sources/nombre-fuente]]`) para evitar resoluciones incorrectas hacia `raw/`
...
**Acción:** Actualiza `index.md` directamente corrigiendo rutas o entradas faltantes.
